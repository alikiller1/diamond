...
public class Constants {
	...
	public static final String DEFAULT_DOMAINNAME = "cf.diamond.paicaifu.com";

	public static final String DAILY_DOMAINNAME = "cf.diamond.paicaifu.com";
	...
	// public static final String CONFIG_HTTP_URI_FILE =
	// "/diamond-server/config" ;
	// 生产配置域名需要
